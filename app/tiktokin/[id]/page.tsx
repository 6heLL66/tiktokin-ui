        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="bg-[#1A1B1E] border border-[#2A2B2E] rounded-lg p-4">
              ...
              <div className="w-full h-[200px] flex items-center justify-center border border-[#2A2B2E] rounded-md bg-[#0F1011]/50">
                <span className="text-sm text-[#707070]">Chart will be here</span>
              </div>
            </div>
